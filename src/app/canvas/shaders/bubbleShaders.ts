// Stylized Underwater Glass Bubbles with high transparency, subtle Fresnel rim glow & sheer specular glints
export const BUBBLE_VERT = `
  ...
  void main() {
    ...
    // Smooth looping upward float motion with horizontal organic drift
    ...
    // Depth fade out with high transparency (0.40 max)
...
export const BUBBLE_FRAG = `
  ...
  void main() {
    ...
    // Organic rim wobble deformation
    ...
    // 1. Anti-aliased outer edge mask
    float edgeMask = smoothstep(0.48, 0.43, r);

    // 2. Translucent Fresnel Glass Rim
    ...
    // 3. Sheer Crescent Sun Specular Glint (top-left)
